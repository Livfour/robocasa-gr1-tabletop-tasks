...
def create_tabletop_fixtures(layout_id, style_id, rng=None):
    """
    ...
    return create_fixtures_from_yaml(
        get_tabletop_layout_path(layout_id), get_style_path(style_id), rng
    )


def create_fixtures_from_yaml(layout_yaml_path, style_yaml_path, rng=None):
    """
    Initializes fixtures based on the given layout yaml file and style type

    Args:
        layout_yaml_path (str): path to the layout yaml file

        style_yaml_path (str): path to the style yaml file
